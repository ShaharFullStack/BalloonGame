...
const initialStudents = [
    { name: "אורי ב", price: "180.00" },
    { name: "אורי ואלון ורד", price: "300.00" },
    { name: "איה", price: "180.00" },
    { name: "איתן", price: "180.00" },
    { name: "יהונתן", price: "180.00" },
    { name: "יובל", price: "180.00" },
    { name: "מיה", price: "180.00" },
];
...
document.getElementById('printPayments').addEventListener('click', function() {
    ...
    store.getAll().onsuccess = function(event) {
        ...
        printWindow.document.write('<link rel="stylesheet" href="styleHeb.css">');
        ...
        printWindow.document.write('<table><thead><tr><th>Student</th><th>Date</th><th>Amount</th></tr></thead><tbody>');
...
function printPaymentReceipt(studentName) {
    ...
    store.getAll().onsuccess = function(event) {
        ...
        printWindow.document.write('<link rel="stylesheet" href="styleHeb.css">');
        printWindow.document.write('</head><body style="font-size: 20px; text-align: right; direction: rtl;">');
        printWindow.document.write('<h2>Payment Receipt for ' + studentName + '</h2>');
        printWindow.document.write('<table><thead><tr><th>Student</th><th>Date</th><th>Amount</th></tr></thead><tbody>');
        printWindow.document.write(paymentDetails);
        printWindow.document.write('</tbody></table>');
        printWindow.document.write('<h3>Total: ₪' + totalAmount.toFixed(2) + '</h3>');
...
function validateStudentName() {
    ...
    if (studentName.trim() === '') {
        document.getElementById('studentName').setCustomValidity('Student name cannot be empty.');
    } else {
...
function validateLessonPrice() {
    ...
    if (lessonPrice <= 0) {
        document.getElementById('lessonPrice').setCustomValidity('Lesson price must be greater than zero.');
    } else {
